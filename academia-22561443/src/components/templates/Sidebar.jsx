  ...
  return (
    ...
    >
      <div className=" col-start-1 flex flex-col items-center  col-end-3  pt-7 row-start-1 row-span-2 h-full w-full">
        ...
        <TextH2
          content={"Enmanuel Vivas"}
          customStyle={" font-medium text-color-primary "}
        />
        <TextH3
          content={"enmanuelvivas.22@gmail.com"}
          customStyle={" font-medium text-color-neutral-700 "}
        />
      </div>
      ...
      <div className=" pl-4  flex col-span-2 items-center  justify-start row-start-6 w-full row-span-6 relative  h-7">
